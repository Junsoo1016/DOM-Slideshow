...
const gallery2 = document.querySelector(".js-gallery")
console.log(galleryItem)
const gallery = Array.from(galleryItem)
console.log(gallery)
...
*/
let slideCount = gallery.length
let slideWidth = gallery[0].offsetWidth
...
function transitionSlide() {
  if(currentSlide < slideCount) {
    gallery2.style.transform = `translateX(-${currentSlide * slideWidth}px)`
    currentSlide += 1
  } else {
    gallery2.style.transform = `translateX(0)`
